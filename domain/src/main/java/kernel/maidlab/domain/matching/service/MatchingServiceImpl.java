...
public class MatchingServiceImpl implements MatchingService {
	...
	@Override
	public AvailableManagerResponseDto findRandomAvailableManagers(MatchingRequestDto dto) {
		LocalDateTime StartTime = LocalDateTime.parse(dto.getStartTime());
		LocalDateTime EndTime = LocalDateTime.parse(dto.getEndTime());
		String gu = extractGuFromAddress(dto.getAddress());
		return managerService.findRandomAvailableManagers(gu, StartTime, EndTime);
	}
