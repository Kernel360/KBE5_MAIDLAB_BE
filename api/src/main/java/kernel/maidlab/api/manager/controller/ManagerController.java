...
import kernel.maidlab.api.manager.dto.ManagerProfile;
...
public class ManagerController {
	...
	// public ResponseEntity<?> getPresignedUploadUrls(@RequestBody FileNamesRequestDto request) {
	// 	List<String> filenames = request.getFilenames();
	// 	List<PresignedFileResponseDto> presignedUrls = s3service.uploadFile(filenames, "profile_image/");
