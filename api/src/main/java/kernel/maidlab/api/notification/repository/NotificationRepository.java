...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    Page<Notification> findByReceiverIdAndReceiverTypeOrderByCreatedAtDesc(Long receiverId, UserType receiverType, Pageable pageable);
    
    // 특정 사용자의 특정 타입 알림 조회
    List<Notification> findByReceiverIdAndNotificationTypeOrderByCreatedAtDesc(Long receiverId, NotificationType notificationType);
    
    // 특정 사용자(ID + 타입)의 특정 알림 타입 조회
    List<Notification> findByReceiverIdAndReceiverTypeAndNotificationTypeOrderByCreatedAtDesc(Long receiverId, UserType receiverType, NotificationType notificationType);
    ...
    int markAllAsReadByReceiverIdAndType(@Param("receiverId") Long receiverId, @Param("receiverType") UserType receiverType);
